...
QTreeWidgetItem* FileDialog::getMasters(const QString& esm) {
...
void FileDialog::check(QTreeWidgetItem* item, QString file) {
...
void FileDialog::onItemChanged(QTreeWidgetItem* item, int column) {
...
void FileDialog::updateToBeLoadedList() {
	ui.lstLoaded->clear();
...
const QString& FileDialog::getActiveFile() const {
	return activeFile;
}

const QSet<QString>& FileDialog::getFilesToLoad() const {
	return filesToLoad;
}
